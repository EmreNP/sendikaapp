...
export const logger = {
  ...
  error: console.error.bind(console),   // Release'de de logla — hatalar her zaman görünür olmalı
  warn: console.warn.bind(console),     // Release'de de logla — uyarılar logcat'te görünsün
