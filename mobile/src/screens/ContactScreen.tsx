...
const contactInfo = [
  { 
    ...
    icon: 'phone' as const, 
    label: 'Telefon', 
    value: '+90 (332) 123 45 67', 
    action: 'tel:+903321234567',
  ...
  { 
    ...
    icon: 'mail' as const, 
    label: 'E-posta', 
    value: 'info@konyadingorevlileri.org', 
    action: 'mailto:info@konyadingorevlileri.org',
  ...
  { 
    ...
    label: 'Adres', 
    value: 'Mevlana Mah. Selçuklu Cad. No: 42, 42000 Selçuklu/Konya',
